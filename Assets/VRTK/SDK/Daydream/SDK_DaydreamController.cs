...
namespace VRTK
{
...
#endif
    {
        ...
        public override GameObject GetControllerRightHand(bool actual = false)
        {
            ...
            {
                controller = VRTK_SharedMethods.FindEvenInactiveGameObject<WaveVR_ControllerLoader>("ControllerLoader_R");
            }
            if (controller != null)
            {
                prevPosition = controller.transform.position;
        ...
        {
            return (buttonType == ButtonTypes.Touchpad ? WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetAxis(wvr.WVR_InputId.WVR_InputId_Alias1_Touchpad) : Vector2.zero);
        }
        ...
        public override bool GetControllerButtonState(ButtonTypes buttonType, ButtonPressTypes pressType, VRTK_ControllerReference controllerReference)
        {
            switch (buttonType)
            {
                case ButtonTypes.Touchpad:
                    switch (pressType)
                    {
                        case ButtonPressTypes.Press:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetPress(wvr.WVR_InputId.WVR_InputId_Alias1_Touchpad);
                        case ButtonPressTypes.PressDown:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetPressDown(wvr.WVR_InputId.WVR_InputId_Alias1_Touchpad);
                        case ButtonPressTypes.PressUp:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetPressUp(wvr.WVR_InputId.WVR_InputId_Alias1_Touchpad);
                        case ButtonPressTypes.Touch:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetTouch(wvr.WVR_InputId.WVR_InputId_Alias1_Touchpad);
                        case ButtonPressTypes.TouchDown:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetTouchDown(wvr.WVR_InputId.WVR_InputId_Alias1_Touchpad);
                        case ButtonPressTypes.TouchUp:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetTouchUp(wvr.WVR_InputId.WVR_InputId_Alias1_Touchpad);
                    }
                    break;
                case ButtonTypes.ButtonOne:
                    ...
                    {
                        case ButtonPressTypes.Press:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetPress(wvr.WVR_InputId.WVR_InputId_Alias1_Menu);
                        case ButtonPressTypes.PressDown:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetPressDown(wvr.WVR_InputId.WVR_InputId_Alias1_Menu);
                        case ButtonPressTypes.PressUp:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetPressUp(wvr.WVR_InputId.WVR_InputId_Alias1_Menu);
                    }
                    break;
                case ButtonTypes.Trigger:
                    ...
                    {
                        case ButtonPressTypes.Press:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetPress(wvr.WVR_InputId.WVR_InputId_Alias1_Bumper);
                        case ButtonPressTypes.PressDown:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetPressDown(wvr.WVR_InputId.WVR_InputId_Alias1_Bumper);
                        case ButtonPressTypes.PressUp:
                            return WaveVR_Controller.Input(wvr.WVR_DeviceType.WVR_DeviceType_Controller_Right).GetPressUp(wvr.WVR_InputId.WVR_InputId_Alias1_Bumper);
                    }
                    break;
            }
            return false;
